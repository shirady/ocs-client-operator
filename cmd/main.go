...
func init() {
	...
	// ObjectBucketClaim from noobaa (objectbucket.io CRD); nbapis.AddToScheme does not register OBC types
...
func main() {
	...
	if err = (&controller.OBCReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "OBC")
		os.Exit(1)
	}
